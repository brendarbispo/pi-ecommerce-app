            ...
            <div class="card">
                <form method="post" action="{{url('/endereco')}}">
                    ...
                    <div class="form-row card-body">
                        ...
                        <input name="nome" type="text" class="form-control" id="nome" placeholder="Casa, trabalho ...">
                    </div>
                    <div class="form-row card-body">
                        <label for="logradouro">Logradouro</label>
                        <input type="text" name="logradouro" class="form-control" id="logradouro" placeholder="Rua das gaivotas...">
                    </div>
                    <div class="form-row card-body">
                        <label for="numero">Numero</label>
                        <input type="number" class="form-control" id="numero" name="num">
                    </div>
                    <div class="form-row card-body">
